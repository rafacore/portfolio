...
const TimelineItem = ({ experience, index }: any) => {
  ...
  return (
    ...
    >
      <motion.div
        className="timeline-content backdrop-blur-sm bg-[#0300145e] rounded-xl p-6 border border-[#7042f861] w-full
        shadow-[0_0_15px_rgba(112,66,248,0.1)]"
        variants={glowVariants}
        initial="initial"
        whileHover="hover"
      >
        <div className="company bg-gradient-to-r from-purple-500 to-cyan-500 bg-clip-text text-transparent text-xl font-bold mb-2">
          {experience.company}
        </div>
      ...
      <motion.div 
        className="timeline-point w-4 h-4 rounded-full bg-gradient-to-r from-purple-500 to-cyan-500"
...
const Experience = () => {
  return (
    ...
    >
      ...
      <motion.div 
        className="timeline relative w-full max-w-[1000px] mt-10"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        <div className="absolute left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-purple-500 to-cyan-500 opacity-20" />
      </motion.div>
