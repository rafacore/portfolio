...
const Button = ({label, href} :Props) => {
  return (
    ...
    rounded-lg w-full max-w-[200px] bg-gradient-to-r from-purple-500 to-cyan-500 hover:shadow-2xl hover:shadow-purple-600/30
   
    
    hover:shadow-purple-600/30 hover:bg-gradient-to-l"
  >
    <div 
    className=' flex bg-gray-900 rounded-lg h-full w-full items-center justify-center py-5
