...
const Button = ({label, href} :Props) => {
  return (
    ...
    rounded-lg w-full max-w-[200px] bg-gradient-to-r from-purple-500 to-cyan-500 hover:shadow-2xl hover:shadow-purple-600/30 transition duration-300 hover:shadow-purple-600/30 hover:bg-gradient-to-l"
  >
